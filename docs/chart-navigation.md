...
- The Investment History Dividends toggle controls the cumulative personal-dividend series. Value mode shows pure Position Value; Economic Value adds cumulative recorded dividends and attributed sale proceeds. The toggle, viewport, and drawer survive Value/Economic Value switching. No personal dividends means no dividend axis.
